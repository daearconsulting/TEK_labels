...
def assign_labels_to_geodataframe(
    ...
    with labeled zone polygons. Features that do not overlap any labeled zone receive None for label fields.
    ...
    # Handle multiple matches (take the first most specific zone)

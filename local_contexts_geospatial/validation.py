...
from .labels import TKLabel, BCLabel, has_tk_label, has_bc_label, has_any_label
...
def validate_label_present(
    ...
    warn_only : If True, emit a warning. If False, raise ValueError.
...
def validate_export_ready(
    ...
    # Check: Usage compatible with label
    if label_present:
    ...
    # Check: Contact info present (optional)
    if require_contact:
